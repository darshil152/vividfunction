		...
		option && (
          ...
          <div className="d-flex align-items-center">
            <div className="position-relative rtd-table-search-btn">
              ...
              >
                <path
                  d="M7.95473 1C6.57921 1 5.23459 1.40787 4.09089 2.17204C2.94719 2.93622 2.05579 4.02236 1.5294 5.29313C1.00301 6.5639 0.865287 7.96222 1.13364 9.31126C1.40199 10.6603 2.06436 11.8995 3.03699 12.8721C4.00963 13.8447 5.24884 14.507 6.59793 14.7754C7.94701 15.0437 9.34538 14.906 10.6162 14.3796C11.887 13.8533 12.9732 12.9619 13.7374 11.8182C14.5016 10.6746 14.9095 9.32997 14.9095 7.9545C14.9093 6.11009 14.1766 4.34125 12.8723 3.03706C11.5681 1.73286 9.7992 1.00012 7.95473 1V1Z"
                  stroke="#5e5873"
                  strokeWidth="1.875"
                  strokeMiterlimit="10"
                />
                <path
                  d="M13.143 13.1431L18.0001 18"
                  stroke="#5e5873"
                  strokeWidth="1.875"
                  strokeMiterlimit="10"
                  strokeLinecap="round"
				...
				<div className="row align-items-center custom-table-btm text-center">
					{option.totalRecord > 0 && (
						<div className="col-sm-12 d-md-flex align-items-center mt-2">
							...
							<div className="ms-auto d-sm-flex align-items-center mt-3 mt-md-0">
								...
								<div className="pagination-custom-info mt-3 mt-sm-0 d-flex align-items-center">
									<ReactPaginate
										...
										previousLabel={
											<span aria-hidden="true" className="previes-icon">
												<svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" viewBox="0 0 24 24" fill="none" stroke="#56CCF2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-chevron-left">
										...
										nextLabel={
											<span aria-hidden="true">
												<svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" viewBox="0 0 24 24" fill="none" stroke="#56CCF2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-chevron-right">
